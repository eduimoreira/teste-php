  ...
  <div class="grid">
    ...
    <form  method="POST" class="form login">
      ...
      <div class="form__field">
        ...
        <input autocomplete="username" id="login__username" type="text" name="usuario" class="form__input" placeholder="Username" required>
      </div>
      ...
      <div class="form__field">
        ...
        <div class="form__field">
    <p >Not a member? <a href="registrar.php">Registre-se</a> 
        </div>
      </p>
